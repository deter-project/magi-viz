...
try {
  ...
  $first = $collection->find(array("port" => "out-node-4"), array("created" => 1, "bytes" => 1))->sort(array("created" => 1))->limit(1);
 ...
 // print_r($array);
  ...
  $cursor = $collection->find(array("created" => array('$gt' => $newts),"port" => "out-node-4"), array("created" => 1, "bytes" => 1))->sort(array("created" => 1))->limit(1);
